...
* ลงคะแนนแบบ 1 ครั้งต่อการเลือกตั้ง
...
* ใช้ตรวจสอบประวัติในหน้า `/me/votes`
...
```json
{
  ...
  "name": "นายสมชาย ใจดี",
  "classRoom": "ม.5/3",
  "rawText": "ข้อมูลดิบที่ OCR อ่านได้"
}
```
...
4. UI แสดงหน้า Vote Success พร้อม Token
